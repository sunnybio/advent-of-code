...
func main() {
	...
	// constant array to check for the number in words
	numArr := [10]string{"one", "two", "three", "four", "five", "six", "seven", "eight", "nine"}
	fmt.Println(numArr)
	var sum int32 = 0
	// iterating lines to get the values
	for s.Scan() {
...
func isInteger(asciiVal byte) bool {
